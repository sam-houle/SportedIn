                  ...
                  <form action="includes/signup.inc.php" method="POST" enctype="multipart/form-data" class="col s12" id="formInscription" name="formInscription">
                    ...
                    <div class="row">
                      <div class="input-field col s6">
					    ...
					    <div class="input-field col s6">
                        <input id="confirmCourriel" name="confirmCourriel" type="email">
                    ...
                    <div class = "row">
						...
						<div class="col s6">					
							...
							<input id="naissance" name="naissance" type="date" class="datepicker"/>    
						</div>     
					</div>     
                </div>
					<div class = "row">
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        <textarea id="texte" name="texte" class="materialize-textarea" length="500"></textarea>
