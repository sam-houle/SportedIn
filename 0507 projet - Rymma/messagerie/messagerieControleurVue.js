...
function afficherMsgAmiV(reponse){
	var listeMsg = reponse.listeMsg;
	var taille=listeMsg.length;
	var rep="<h5 class=\"email-subject truncate\">"+ listeMsg[0].prenom + " " + listeMsg[0].nom +" <i class=\"mdi-action-star-rate yellow-text text-darken-3 right\"></i></h5>";
	for(var i=0; i<taille; i++){
		rep+="<hr class=\"grey-text text-lighten-2\"><p class=\"blue-text ultra-small\">" + listeMsg[i].stamp + "</p> <div class=\"email-content-wrap\"> <div class=\"row\"> <div class=\"email-content col s12 m8 l8\"> <p>" + listeMsg[i].contenu + "</p></div></div></div>";
	}
