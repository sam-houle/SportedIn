...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 04 mai 2018 à 18:52
...
(3, 1, 2, '2018-05-04 14:52:32', 'Est-ce que vous serai interessez à venir jouer au basketball la semaine prochaine?'),
...
(6, 2, 1, '2018-05-04 14:53:56', 'Oui, je vais créer un event pour mardi prochain en soirée.');
...
--
ALTER TABLE `message`
  MODIFY `id_msg` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
