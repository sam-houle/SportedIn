...
function afficherMsgV(reponse){
	...
	for(var i=0; i<taille; i++){
		rep+="<li class=\"collection-item avatar email-unread\" onclick=\"afficherMsgAmi("+listeMsg[i].membre_deux+");\"> <span class=\"circle red lighten-1\"></span> <span class=\"email-title\">"+listeMsg[i].prenom + " " + listeMsg[i].nom + "</span> <p class=\"blue-text ultra-small\">" + listeMsg[i].temps+ "</p></li>";
		}
