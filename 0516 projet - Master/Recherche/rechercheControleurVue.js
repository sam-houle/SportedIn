...
function afficherProfileAutreVue(reponse){
	...
	profile+="<img src=\"photoMembre/"+autreMembre[0].photo+"\"</img></div><div class=\"card-stacked\"><div class=\"card-content\" id=\"infoProfil\">";
	profile+="<h5 class=\"header\">"+autreMembre[0].prenom+" "+autreMembre[0].nom+"</h5><b>"+autreMembre[0].province+", "+autreMembre[0].ville+", "+autreMembre[0].quartier+"</b><p>"+autreMembre[0].profession+"</p><p>"+autreMembre[0].age+" ans</p><p>"+autreMembre[0].sexe+"</p><a class=\"btn-floating btn waves-effect waves-light grey bottom\" id=\"ajoutAmiCouleur\" onclick=\"DemandeAmi("+autreMembre[0].id_membre+");\"><i class=\"material-icons\" id=\"ajoutAmiIcone\">exposure_plus_1</i></a><b><p id=\"messageDemande\" style=\"display: inline-block;\"></p></b>";
...
function afficherSportProfAutre(reponse){
	...
	for(i=0;i<taille;i++){
		...
		repSport+="<li><a class=\"waves-effect waves-light "+couleur+" accent-2 btn-small\">"+sportAutreMembre[i].nom+"</a></i></li>";
	}
...
var rechercheVue=function(reponse){
	...
	switch(action){
		...
		break;
		case "afficherProfileAutreVue" :
			afficherProfileAutreVue(reponse);
			afficherSportProfAutre(reponse);
		break;
