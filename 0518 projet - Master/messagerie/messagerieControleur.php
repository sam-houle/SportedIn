<?php
	...
	function afficherMsg(){
		...
		$user=$_SESSION['u_id'];
		try{
			$requette = "SELECT membre_deux, prenom, nom, photo, MAX(stamp) temps FROM conversation, membre, message where membre_deux=id_membre and membre_un=? and message.id_convo=conversation.id_convo group by prenom, nom";
