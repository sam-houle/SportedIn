function afficherMsgV(reponse){
	...
	var rep="<div class=\"container\" id=\"divMessagerie\"> <div class=\"col s12 m9\" > <div class=\"row\"> <div class=\"col s12\"> <nav class=\"green darker-2\"> <div class=\"nav-wrapper\"> <div class=\"left col s12 m5 l5\"> <ul> <li><h5>Messagerie</h5> </ul> </div> </div> </nav> </div> <div class=\"col s12\"> <div id=\"email-list\" class=\"col s10 m4 l4 card-panel z-depth-1\"> <ul class=\"collection\">";
	
	for(var i=0; i<taille; i++){
		rep+="<li class=\"collection-item avatar email-unread\" onclick=\"afficherMsgAmi("+listeMsg[i].membre_deux+");\"><img width=\"50\" height=\"50\" class=\"responsive-img circle\" src=\"PhotoMembre/"+listeMsg[i].photo+"\"><span class=\"email-title\">"+listeMsg[i].prenom + " " + listeMsg[i].nom + "</span> <p class=\"blue-text ultra-small\">" + listeMsg[i].temps+ "</p></li>";
		}
	rep+="</ul></div><div id=\"email-details\" class=\"col s12 m8 l8 card-panel\"></div></div></div>";
	$('#content').html(rep);
...
function afficherMsgAmiV(reponse){
	...
	rep+="<br><div class=\"input-field col s12\"><form id=\"formAjoutMsg\" name=\"formAjoutMsg\" method=\"post\" enctype=\"multipart/form-data\"><textarea id=\"textAjoutMsg\" name=\"textAjoutMsg\" class=\"materialize-textarea\" length=\"1000\"></textarea> <label for=\"compose\">Composez votre message</label></div><div class=\"input-field col s12\"><button class=\"btn waves-effect waves-light green\" type=\"submit\" name=\"action\" onClick=\"ajouterMsg("+ listeMsg[0].id + ");\">Envoyer<i class=\"material-icons right\">send</i></button>";
	rep+="<a class=\"btn-floating waves-effect waves-light orange right\" onClick=\"ajouterEvent("+ listeMsg[0].id + ");\"><i class=\" material-icons\">perm_contact_calendar</i></a></form></div>";
