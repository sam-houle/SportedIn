...
function afficherMsgV(reponse){
	...
	var rep="<div class=\"container\" id=\"divMessagerie\" style=\"display:none\"> <div class=\"col s12 m9\" > <div class=\"row\"> <div class=\"col s12\"> <nav class=\"orange\"> <div class=\"nav-wrapper\"> <div class=\"left col s12 m5 l5\"> <ul> <li><h5>Messagerie</h5> </ul> </div> </div> </nav> </div> <div class=\"col s12\"> <div id=\"email-list\" class=\"col s10 m4 l4 card-panel z-depth-1\"> <ul class=\"collection\">";
	
	for(var i=0; i<taille; i++){
		rep+="<li class=\"collection-item avatar email-unread\" onclick=\"afficherMsgAmi("+listeMsg[i].id_membre+");\"> <span class=\"circle red lighten-1\"></span> <span class=\"email-title\">"+listeMsg[i].prenom + listeMsg[i].nom + "</span> <p class=\"blue-text ultra-small\">" + listeMsg[i].stamp+ "</p></li>";
		}
	rep+="</ul></div></div></div></div>";
	$('#content').html(rep);
